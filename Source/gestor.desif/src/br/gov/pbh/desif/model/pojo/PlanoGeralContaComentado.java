...
public class PlanoGeralContaComentado
extends AbstractPlanoGeralContaComentado
implements Serializable {
    public PlanoGeralContaComentado() {
    }

    public PlanoGeralContaComentado(String conta, String contaCosif, Long numLinhaPgcc, String nome, String contaSupe, String codTribDesif, String descConta, String filhos, Integer nivel, Set pgccsPaiFilhosForIdnPgccPai, Set pgccsPaiFilhosForIdnPgccFilho) {
