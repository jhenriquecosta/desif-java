...
public class ProtocoloAMI {
    ...
    public ProtocoloAMI(Long id, String raizCnpj, String nome, String anoMesInicCmpe, Short tipoDecl, Short tipoCnso, Timestamp dataEntrega, String verTermoRef, Double verValidador, String xmlAssinado, Short modulo, List<DependenciaProtocoloAMI> listaDependencia, List<TotalizacaoProtocoloAMI> listaTotalizacao) {
        this.id = id;
