...
public class BalanceteAnaliticoMensal
extends AbstractBalanceteAnaliticoMensal
implements Serializable {
    public BalanceteAnaliticoMensal() {
    }

    public BalanceteAnaliticoMensal(Long id, Long linhaBalanceteAnaliticoMensal, String codigoDependencia, Date AnoMesCompetencia, String conta, Double saldoInicial, Double valorDebito, Double valorCredito, Double saldoFinal) {
