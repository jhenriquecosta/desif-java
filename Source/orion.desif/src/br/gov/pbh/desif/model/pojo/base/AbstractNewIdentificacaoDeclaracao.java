...
// Referenced classes of package br.gov.pbh.desif.model.pojo.base:
//            AbstractIdentificacaoDeclaracao

public abstract class AbstractNewIdentificacaoDeclaracao extends AbstractIdentificacaoDeclaracao
    implements Serializable
{
    ...
    public AbstractNewIdentificacaoDeclaracao(Integer id, String titulo, Long cidade, Integer linhaIdentificacaoDeclaracao, String cnpjInstituicao, String nomeInstituicao, Date dataInicioCompetencia, 
            Date dataFimCompetencia, Short moduloDeclaracao, Short tipoDeclaracao, Short tipoConsolidacao, String cnpjResponsavelRecolhimento, String protocoloDeclaracao, String idnVersao, 
            Short tipoArredondamento)
    {
